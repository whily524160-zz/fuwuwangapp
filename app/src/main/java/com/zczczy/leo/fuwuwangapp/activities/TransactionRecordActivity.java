 ...
 */
@EActivity(R.layout.transaction_record_layout)
@WindowFeature(value = {Window.FEATURE_NO_TITLE, Window.FEATURE_INDETERMINATE_PROGRESS})
public class TransactionRecordActivity extends BaseActivity implements PullToRefreshLayout.OnRefreshListener{
    ...
    MyBaseAdapter<TransactionRecord> myAdapter;

    @StringRes
    String txt_transaction_record_title;
    ...
    void afterView() {
        ...
        title.setTitle(txt_transaction_record_title);
